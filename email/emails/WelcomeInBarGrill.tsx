    ...
    <Html style={styles.html}>
      ...
      <Container style={styles.container}>
        ...
        <Text style={GlobalStyles.text}>
          ...
          improve your website. Did you know that{" "}
        ...
        <Text style={GlobalStyles.text}>
          ...
          7 on Google Maps and your website doesn't even appear in Google Search
          results for "restaurants hoquiam washington." And despite your
          goodratings, you aren't you listed in the top five results with a{" "}
          <span style={{ display: "inline-block", fontSize: "13px" }}>
            (4.4<span style={{ color: "#FF9800" }}>&#x2730;</span>/5
            <span style={{ color: "#FF9800" }}>&#9733;</span>)
          </span>{" "}
          . Even Golden Dragon whose score is much lower appears in the number 6
          spot ahead of you on Google Maps.
          <img
            src="https://isaachormel.com/images/email/WelcomeInnBarGrill/Lighthouse.jpg"
...
export default WelcomeInNBarGrill;
